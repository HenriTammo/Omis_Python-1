...
aken.onkeypress(liigu_yles_vasak(ristkylikVasak), "w")  #nupuvajutus- üles- w
aken.onkeypress(liigu_alla_vasak(ristkylikVasak), "s")
aken.onkeypress(liigu_yles_parem(ristkylikParem), "p")
aken.onkeypress(liigu_alla_parem(ristkylikParem), "l")
